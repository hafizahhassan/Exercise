...
with st.form("city_input_form"):
    ...
    for i in range(1, 11):
        ...
        x = col2.number_input(f"X Coordinate", min_value=1, max_value=10, step=1, key=f"x{i}")
        y = col3.number_input(f"Y Coordinate", min_value=1, max_value=10, step=1, key=f"y{i}")
