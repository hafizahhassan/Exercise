...
def get_city_input():
    ...
    for i in range(10):
        ...
        x_coord = st.number_input(f"Enter x-coordinate for {city_name}:", min_value=1, max_value=10)
        y_coord = st.number_input(f"Enter y-coordinate for {city_name}:", min_value=1, max_value=10)
